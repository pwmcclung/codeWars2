"""Clickbait Headline Generator, inspired by Al Swiegart, al@inventwithpython.com
...
def main():
    ...
    while True:
        ...
        if not response.isdecimal():
            ...
            break # Exit the game loop once a valid number is entered
...
# if the program is run (instead of imported) run the gameL:
